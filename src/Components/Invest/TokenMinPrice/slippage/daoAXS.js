...
class DAOAXSTokenMinPrice {    
    static getAmountsOut = async(object) => {
        ...
        const deXStableVault = new web3.eth.Contract(asset.vaultAddress, asset.vaultInfo.abi);
        const dexStableStrategy = new web3.eth.Contract(asset.address, asset.abi);
        ...
        if(amtWithdrawInUSD.gt(totalAmtInVault)) {
            ...
            let JOEUSDCBalance = await JOEUSDCVault.methods.balanceOf(asset.address).call();
            ...
            let PNGUSDTBalance = await PNGUSDTVault.methods.balanceOf(asset.address).call();
            ...
            let LYDDAIBalance = await LYDDAIVault.methods.balanceOf(asset.address).call();
